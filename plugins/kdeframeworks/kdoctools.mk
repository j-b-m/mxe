...
PKG             := kdoctools
$(PKG)_VERSION  := 5.29.0
$(PKG)_CHECKSUM  := 60badcc58d9d79514fdc1061704e7999021d5cfcdb2b1201ad846f2508fba37d
$(PKG)_SUBDIR   := $(PKG)-$($(PKG)_VERSION)
$(PKG)_FILE     := $(PKG)-$($(PKG)_VERSION).tar.xz
$(PKG)_HOME     := http://download.kde.org/stable/frameworks
$(PKG)_URL      := $($(PKG)_HOME)/$(basename $($(PKG)_VERSION))/$($(PKG)_FILE)
$(PKG)_DEPS     := qtbase extra-cmake-modules karchive ki18n libxslt docbook-xml docbook-xsl
